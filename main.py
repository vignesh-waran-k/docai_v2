...
from utilities import list_blobs,copy_blob, batch_process_documents_sample
...
def batch_caller(gcs_input_uri, gcs_output_uri):
    ...
    operation = batch_process_documents_sample(project_id, location, processor_id, gcs_input_uri, f"{gcs_output_uri}/{gcs_output_uri_prefix}/")
...
def concurrentProcessing(batch_caller,daira_output_test : str,batch_array : List)->None:
    """
